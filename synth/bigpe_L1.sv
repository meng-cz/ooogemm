...
module bigpe_L1 (
    ...
    input  logic [0:0] left_valid_i,
    input  logic [7:0] left_a_i,
    input  logic [0:0] left_first_i,
    input  logic [0:0] left_last_i,
    input  logic [3:0] left_paccidx_i,
    input  logic [0:0] left_accum_i,

    output logic [0:0] right_valid_o,
    output logic [7:0] right_a_o,
    output logic [0:0] right_first_o,
    output logic [0:0] right_last_o,
    output logic [3:0] right_paccidx_o,
    output logic [0:0] right_accum_o,

    input  logic [7:0] top_b_i,
    output logic [7:0] bottom_b_o,
    ...
    localparam int GEMM_LANE_NUM = 1;
