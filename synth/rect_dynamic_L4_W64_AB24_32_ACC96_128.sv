...
// Fixed synthesis wrapper for the rect_dynamic rect_dynamic_L4_W64_AB24_32_ACC96_128 experiment configuration.
module rect_dynamic_L4_W64_AB24_32_ACC96_128 #(
    parameter int SA_WIDTH = 64,
    parameter int SUBTILE_M = 16,
    parameter int SUBTILE_N = 64,
    ...
    parameter int ABUF_LOGIC_SIZE = 24,
    parameter int BBUF_LOGIC_SIZE = 24,
    parameter int PACC_LOGIC_SIZE = 96,
