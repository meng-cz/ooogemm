...
// Fixed synthesis wrapper for the rect_dynamic rect_dynamic_L1_W128_AB24_32_ACC96_128 experiment configuration.
module rect_dynamic_L1_W128_AB24_32_ACC96_128 #(
    parameter int SA_WIDTH = 128,
    parameter int SUBTILE_M = 32,
    parameter int SUBTILE_N = 128,
