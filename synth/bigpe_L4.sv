...
module bigpe_L4 (
    ...
    input  logic [3:0] left_valid_i,
    input  logic [31:0] left_a_i,
    input  logic [3:0] left_first_i,
    input  logic [3:0] left_last_i,
    input  logic [15:0] left_paccidx_i,
    input  logic [3:0] left_accum_i,

    output logic [3:0] right_valid_o,
    output logic [31:0] right_a_o,
    output logic [3:0] right_first_o,
    output logic [3:0] right_last_o,
    output logic [15:0] right_paccidx_o,
    output logic [3:0] right_accum_o,

    input  logic [31:0] top_b_i,
    output logic [31:0] bottom_b_o,
    ...
    localparam int GEMM_LANE_NUM = 4;
