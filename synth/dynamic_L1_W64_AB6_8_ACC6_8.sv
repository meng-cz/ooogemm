...
// Fixed synthesis wrapper for the dynamic dynamic_L1_W64_AB6_8_ACC6_8 experiment configuration.
module dynamic_L1_W64_AB6_8_ACC6_8 #(
    parameter int SA_WIDTH = 64,
    parameter int SUBTILE_M = 64,
    ...
    parameter int PACC_NUM = 8,
    parameter int ABUF_LOGIC_SIZE = 6,
    parameter int BBUF_LOGIC_SIZE = 6,
    parameter int PACC_LOGIC_SIZE = 6,
