...
// Fixed synthesis wrapper for the rect_dynamic rect_dynamic_L16_W32_AB24_32_ACC96_128 experiment configuration.
module rect_dynamic_L16_W32_AB24_32_ACC96_128 #(
    parameter int SA_WIDTH = 32,
    parameter int SUBTILE_M = 8,
