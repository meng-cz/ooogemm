...
BUILD_DIR="${BUILD_DIR:-/tmp/top_static_staticmn_verilator_${SA_WIDTH}_${SUBTILE_M}_${SUBTILE_N}_${SUBTILE_K}_${ABUF_SIZE}_${BBUF_SIZE}_${PACC_NUM}}"
...
verilator \
  ...
  "${SCRIPT_DIR}/top_static_staticmn.cpp"

"${BUILD_DIR}/Vtop_static_staticmn"
