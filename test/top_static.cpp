...
constexpr int kParserBlockM =
    choose_parser_block_m(kABufSize / 2, kBBufSize / 2, kPaccNum / 2);
constexpr int kParserBlockN =
    choose_parser_block_n(kABufSize / 2, kBBufSize / 2, kPaccNum / 2);
constexpr int kParserBlockArea = kParserBlockM * kParserBlockN;
constexpr int kParserMergeBlockTiles = std::min(
    kParserBlockArea,
    std::min(kPaccNum / 2, std::min(kABufSize / 2, kBBufSize / 2))
);
