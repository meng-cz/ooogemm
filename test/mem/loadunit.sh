...
verilator \
  ...
  -CFLAGS "-DSA_WIDTH_TEST=${SA_WIDTH} -DSUBTILE_K_TEST=${SUBTILE_K} -DABUF_SIZE_TEST=${ABUF_SIZE} -DBBUF_SIZE_TEST=${BBUF_SIZE} -DBUS_ID_WIDTH_TEST=${BUS_ID_WIDTH} -DLOAD_DATA_WIDTH_TEST=${LOAD_DATA_WIDTH}" \
