...
verilator \
  ...
  -CFLAGS "-DSA_WIDTH_TEST=${SA_WIDTH} -DSUBTILE_K_TEST=${SUBTILE_K} -DABUF_SIZE_TEST=${ABUF_LOGIC_SIZE} -DBBUF_SIZE_TEST=${BBUF_LOGIC_SIZE} -DPACC_NUM_TEST=${PACC_LOGIC_SIZE}" \
